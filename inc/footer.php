            ...
            <div class="row g-lg-4 gy-5 justify-content-center">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="footer-widget">
                        <h3>Want <span>to Take </span>Beauty Product ?</h3>
                        <a href="#" class="primary-btn1 hover-btn3">*Buy Now Form AMAZON *</a>
                        <a href="#" class="primary-btn1 style-3 hover-btn4">*Buy Now Form FLIPKART*</a>
                    </div>
                </div>
                ...
                <div
                    class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-center justify-content-md-start justify-content-sm-end">
                    <div class="footer-widget">
                        <div class="widget-title">
                            <h5>Products</h5>
                        </div>
                        <ul class="widget-list">
                            <li><a href="pigmentation_repair.php">Pigmentation Repair Cream</a></li>
                            <li><a href="aloevera_neem.php">Aloevera & Neem</a></li>
                            <li><a href="hair_amrut.php">Hair Amrut</a></li>
                            <li><a href="aloevera_gel.php">Aloe Vera Gel</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-end justify-content-md-center">
                    <div class="footer-widget">
                        ...
                        <div class="payment-gateway">
                            <div class="icons">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3666.7793909629063!2d77.45705827795864!3d23.21470905510882!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c422c4be0b59f%3A0x772ec043035da6c6!2s351%2C%202c%2C%20Saket%20Nagar%2C%20Berkheda%2C%20Bhopal%2C%20Madhya%20Pradesh%20462024!5e0!3m2!1sen!2sin!4v1710395465931!5m2!1sen!2sin"
                                    style="border:0;" allowfullscreen loading="lazy" height="200"
        ...
        <div class="footer-bottom">
            <div class="row">
                <div
                    ...
                    <p>Copyright © 2024 <span></span>3All
                        Rights Reserved Created
                        by
                        <span><a href="https://digirank360.com/">Digirank360</a></span>
                    </p>
                </div>
                    <div class="footer-logo">
                        <a href="index.php"><img src="assets/images/logo/logo-transparent-png.png"
                    ...
                    <div class="footer-contact">
                        ...
                        <div class="content">
                            <p>For Inquiry</p>
                            <h6><a href="tel:+919589397454">+91 95893 97454</a></h6>
                        </div>
                    </div>
                </div>
            </div>
